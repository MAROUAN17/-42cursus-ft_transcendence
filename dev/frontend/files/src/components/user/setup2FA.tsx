      ...
      <div className="items-center">
        <div className="text-center align-center space-y-6">
          <div className="space-y-5">
            ...
            <h1 className="text-white font-bold text-5xl">Scan QR code</h1>
            <p className="text-white text-xl font-light">
              Scan this QR code in-app to verify the device
            </p>
          </div>
        </div>
        ...
        <form onSubmit={formHandler}>
          <div className="flex justify-center space-x-12">
            <div className="flex justify-center space-x-3 text-center mt-20">
              <input
                ...
                ref={input1Ref}
                value={firstNbr}
                className=" text-white text-4xl text-center w-[60px] h-[89px] bg-gameBg border border-white rounded-lg"
                required
                type="text"
              />
              <input
          ...
          <div className="mt-12 text-center">
            <button
              type="submit"
              className="bg-neon text-white text-xl px-[190px] py-3 rounded-lg font-semibold"
            >
              Continue
            </button>
          </div>
