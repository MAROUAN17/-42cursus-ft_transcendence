...
export const delete_Match = (gameId) => {
...
export const pair_players = async (req, res) => {
...
export const get_queue_status = async (req, res) => {
    try {
        res.status(200).send({
...
export const leave_queue = async (req, res) => {
    try {
...
export const get_player_game = async (req, res) => {
    try {
        const playerId = req.params.playerId;
...
export const invite_game = async (req, res) => {
    try {
...
export const updateGameForId = (gameId, updates) => {
    const game = activeGames.find((g) => g.id === gameId);
    if (game) {
...
export const getGameStateById = (gameId) => {
    const game = activeGames.find((g) => g.id === gameId);
