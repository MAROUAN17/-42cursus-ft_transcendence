...
import { pair_players, get_game, get_queue_status, leave_queue, get_player_game, invite_game } from "../services/match.service.js";
import { create_tournament, delete_tournament, get_tournament_by_id, get_tournaments, join_tournament, leave_tournament, get_tournament_winner, get_rounds, start_tournament, start_games, get_final_round, get_score, } from "../services/tournament.service.js";
...
export const gameRoutes = async (fastify) => {
