                    ...
                    <div className="space-y-16">
                        <div>
                            ...
                            <div className="flex items-center mt-5">
                                <input value={newPassword} onChange={passInput} required className={`text-white bg-transparent border-b border-white py-4 w-full`} type="password" placeholder="Password" />
                            </div>
                            {errorFlag && (
                        ...
                        <div className="">
                            ...
                            <div className="">
                                <input value={confirmPassword} onChange={passConfirmInput} required className={`text-white bg-transparent border-b border-white py-4 w-full`} type="password" placeholder="Confirm Password" />
                            </div>
                            {errorFlag && (
                                <p className="mt-3 text-red-500">{errorMssg}</p>
                            )}
