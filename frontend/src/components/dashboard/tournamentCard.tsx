const TournamentCard = () => {
  return (
    <div className="h-1/2 p-2 overflow-hidden box-border">
      <div className="flex text-white  flex-col bg-compBg w-[250px] h-full rounded-[30px] overflow-hidden">
        <img src="/src/assets/tournament_bg.jpeg" className="h-1/2 object-cover" />
